...
// prettier-ignore
export const includeOverlay = (): string => `<script>!function(){if(!["ResizeObserver","IntersectionObserver","MutationObserver","customElements"].every((function(e){return e in window}))){var e=document.createElement("script");e.src="https://cdn.ui.porsche.com/browser-notification/overlay.min.${version}.js",document.body.appendChild(e)}}();</script>`;