...
// prettier-ignore
export const include = (): string => `<script>!function(){var n,e=function(n){var e=document.createElement("script");e.src="https://cdn.ui.porsche.com/browser-notification/"+n+".min.${version}.js",document.body.appendChild(e)};18===((n=/\\b(MSIE |Trident.*?rv:|Edge\\/)(\\d+)/.exec(window.navigator.userAgent||navigator.userAgent))?parseInt(n[2]):-1)?e("banner"):"customElements"in window||e("overlay")}();</script>`;
// prettier-ignore
