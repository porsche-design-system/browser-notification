...
// prettier-ignore
export const include = (): string => `<script>!function(){var n,e="${version}",t=function(n){var e=document.createElement("script");e.src="https://cdn.ui.porsche.com/browser-notification/"+n+".js",document.body.appendChild(e)};"customElements"in window?((n=/\\b(MSIE |Trident.*?rv:|Edge\\/)(\\d+)/.exec(window.navigator.userAgent||navigator.userAgent))?parseInt(n[2]):-1)<=18||t("banner.min."+e):t("overlay.min."+e)}();</script>`;
// prettier-ignore
